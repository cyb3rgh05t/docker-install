#!/bin/bash
#
# NFS Storage Server Optimization Script — storage150
# Server: 168.119.199.34 (AMD Ryzen 9 3900, 128 GB RAM, 10x 14.6TB HDD ZFS RAIDZ1)
...
echo -e "${CYAN}========================================${NC}"
echo -e "${CYAN}  Storage 150 — Full Optimization${NC}"
echo -e "${CYAN}  128 GB RAM · AMD Ryzen 9 3900 · 10GbE${NC}"
echo -e "${CYAN}========================================${NC}"
echo ""
...
# ARC Max: 100 GB (leaves ~28 GB for OS, NFS, page cache)
ARC_MAX=107374182400
# ARC Min: 50 GB (keeps cache hot, prevents aggressive eviction)
ARC_MIN=53687091200
...
echo -e "${GREEN}  ✓ ARC Max: 100 GB | ARC Min: 50 GB${NC}"
...
# ====================================================================
# NFS STORAGE SERVER OPTIMIZATION — storage150 (128 GB RAM)
# ====================================================================
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  ✓ Storage 150 Optimization Complete${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
